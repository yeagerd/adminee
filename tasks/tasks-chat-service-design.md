...
- `services/chat-service/langchain_tools.py` - Custom LangChain tools for office-service integration.
...
- `services/chat-service/tests/test_langchain_tools.py` - Unit tests for LangChain tool integration.
...
- [ ] 3. Implement LangChain integration
  ...
  - [ ] 3.3 Implement notes tool
    - [ ] 3.3.1 Define a LangChain tool for retrieving notes from office-service via REST API.
  ...
  - [ ] 3.4 Implement documents tool
    - [ ] 3.4.1 Define a LangChain tool for retrieving documents from office-service via REST API.
  ...
  - [ ] 3.5 Implement create draft email tool
    - [ ] 3.5.1 Define a LangChain tool for creating or updating the active draft email for a thread (no office-service call).
  ...
  - [ ] 3.6 Implement delete draft email tool
    - [ ] 3.6.1 Define a LangChain tool for deleting the active draft email for a thread (no office-service call).
  ...
  - [ ] 3.7 Implement create draft calendar event tool
    - [ ] 3.7.1 Define a LangChain tool for creating or updating the active draft calendar event for a thread (no office-service call).
  ...
  - [ ] 3.8 Implement delete draft calendar event tool
    - [ ] 3.8.1 Define a LangChain tool for deleting the active draft calendar event for a thread (no office-service call).
  ...
  - [ ] 3.9 Implement create draft calendar change tool
    - [ ] 3.9.1 Define a LangChain tool for creating or updating the active draft calendar change for a thread (no office-service call).
  ...
  - [ ] 3.10 Implement delete draft calendar change tool
    - [ ] 3.10.1 Define a LangChain tool for deleting the active draft calendar change for a thread (no office-service call).
  ...
  - [ ] 3.11 Integrate all tools with LangChain agent and ensure correct registration and invocation.
  - [ ] 3.12 Add integration tests for LangChain agent with all tools and tool command schema.
...
- [ ] 4. Implement history manager
  ...
  - [ ] 4.3 Implement draft storage/retrieval
    ...
    - [ ] 4.3.3 Integrate draft logic with LangChain tools for create/delete/update.
...
- [ ] 5. Implement context module
  ...
  - [ ] 5.3 Integrate context module with chat endpoint and LangChain agent.
...
- [ ] 6. Implement LLM usage tracking
  ...
  - [ ] 6.3 Integrate usage tracking with chat endpoint and LangChain calls.
...
- [ ] 8. Integrate with office-service and handle authentication/authorization
  - [ ] 8.1 Implement HTTP client logic to call office-service endpoints from LangChain tools.
