...
- [x] Remove `services/user/services/contact_discovery_service.py`
- [x] Remove `services/user/services/contact_discovery_consumer.py`
- [x] Remove `services/user/tests/test_contact_discovery_service.py`
- [x] Remove contact-related imports from User Service
- [x] Update User Service to remove contact dependencies
- [x] Ensure User Service tests still pass
...
- [x] Delete old contact-related code
