...
- [x] Create `scripts/subscripts/update-types.sh` for type generation (replaces unused `scripts/generate-types.sh`)
...
scripts/
├── generate-api-schema.sh   # Main orchestrator script
├── subscripts/
