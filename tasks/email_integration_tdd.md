...
- [ ] **Test: Should handle pubsub unavailability**
...
- [ ] **Test: Should handle downstream service unavailability**
...
#### Microsoft Webhook Receiver (Serverless)
...
#### Microsoft Sync Service (Unified or Split)
...
- [ ] **Test: Should handle Microsoft API rate limits and token expiry**
...
#### Amazon Package Status Detection
- [ ] **Test: Should extract Amazon package status updates**
...
- [ ] **Test: Should handle unsupported Amazon email formats**
...
- [ ] **Test: Should handle malformed or unsupported emails gracefully**
...
- [ ] **Test: Should handle pubsub and API failures gracefully**
