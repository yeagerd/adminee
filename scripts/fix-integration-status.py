...
async def main() -> None:
    ...
    parser.add_argument("--user-id", required=True, help="User ID to fix specific user's integrations")
    parser.add_argument("--provider", help="Provider to fix specific provider's integrations")
