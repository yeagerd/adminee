...
async def create_calendar_event(
    ...
    from services.api.v1.office import EmailAddress
    ...
    from services.api.v1.office import CreateCalendarEventRequest
...
async def update_calendar_event(
    ...
    # Convert participants to EmailAddress format
    from services.api.v1.office import CreateCalendarEventRequest, EmailAddress
