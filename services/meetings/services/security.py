...
def check_rate_limit(client_key: str, max_requests: int = 100, window_seconds: int = 3600) -> bool:
    """
...
def get_remaining_requests(client_key: str, max_requests: int = 100, window_seconds: int = 3600) -> int:
