...
class TestSecurityService(BaseMeetingsTest):
    ...
    def test_security_utils_sanitize_input(self):
        ...
        for input_text, expected in test_inputs:
            ...
            assert result == expected, f"Input '{input_text}' should be sanitized to '{expected}', got '{result}'"
    ...
    def test_security_utils_sanitize_input_length_limit(self):
        ...
        assert len(result) == 500, f"Sanitized text should be truncated to 500 characters, got {len(result)}"
    ...
    def test_security_error_handling(self):
        ...
        for malformed_user_id in malformed_user_ids:
            ...
            assert result is False, f"Malformed user ID '{malformed_user_id}' should be rejected"
    ...
    def test_token_generator_evergreen_tokens(self):
        ...
        for token in tokens:
            ...
            assert token[3:].isalnum(), f"Token '{token}' should contain only alphanumeric characters"
    ...
    def test_token_generator_slugs(self):
        ...
        for slug in slugs:
            ...
            assert slug.isalnum(), f"Slug '{slug}' should contain only alphanumeric characters"
