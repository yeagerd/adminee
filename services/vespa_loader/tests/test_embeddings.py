...
class TestEmbeddingGenerator:
    ...
    def test_initialization_failure(self):
        ...
        with patch("builtins.__import__") as mock_import:
            ...
            with pytest.raises(
                RuntimeError, match="Failed to initialize embedding model"
            ):
                EmbeddingGenerator()
    ...
    async def test_find_most_similar(self):
        ...
        with patch("builtins.__import__") as mock_import:
            ...
            result = await generator.find_most_similar(
    ...
    async def test_find_most_similar_with_errors(self):
        ...
        with patch("builtins.__import__") as mock_import:
            ...
            with patch.object(
                generator, "similarity", side_effect=[0.8, Exception("Error"), 0.6]
            ):
                result = await generator.find_most_similar(
    ...
    async def test_generate_embedding_with_preprocessing(self):
        ...
        with patch("builtins.__import__") as mock_import:
            ...
            generator = EmbeddingGenerator()
            result = await generator.generate_embedding_with_preprocessing(
                "  TEST TEXT  "
            )
