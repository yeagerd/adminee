...
class EmailContentProcessor:
        ...
        try:
            ...
            processed_email = {
                ...
                "search_text": self._generate_search_text(
                    subject, processed_body["clean_content"], from_address, to_addresses
                ),
            }

            logger.info(
                f"Processed email {email_data.get('id')} with {len(processed_body['chunks'])} chunks"
            )
    ...
    def _process_body(self, body: str) -> Dict[str, Any]:
        ...
        if not body:
            return {"clean_content": "", "chunks": [], "quoted_content": ""}
    ...
    def _generate_thread_summary(self, email_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "last_updated": email_data.get("updated_at")
            or email_data.get("created_at"),
        }
    ...
    def _generate_search_text(
        self, subject: str, body: str, from_address: str, to_addresses: List[str]
    ) -> str:
