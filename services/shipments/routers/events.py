"""
Tracking events ("/events") endpoints for the shipments service
"""
...
@events_router.get("", response_model=List[TrackingEventOut])
...
@events_router.post("/from-email", response_model=EmailParseResponse)
