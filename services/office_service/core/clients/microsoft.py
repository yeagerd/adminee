...
class MicrosoftAPIClient(BaseAPIClient):
    ...
    async def get_message(self, message_id: str, select: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    async def get_drive_item(self, item_id: str, select: Optional[str] = None) -> Dict[str, Any]:
        """
