...
class GoogleAPIClient(BaseAPIClient):
    ...
    async def get_message(self, message_id: str, format: str = "full") -> Dict[str, Any]:
        ...
        response = await self.get(f"/gmail/v1/users/me/messages/{message_id}", params=params)
        return response.json()
    ...
    async def send_message(self, message_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        response = await self.post("/gmail/v1/users/me/messages/send", json_data=message_data)
        return response.json()
    ...
    async def get_events(
        ...
        response = await self.get(f"/calendar/v3/calendars/{calendar_id}/events", params=params)
        return response.json()
    ...
    async def create_event(self, calendar_id: str, event_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        response = await self.post(f"/calendar/v3/calendars/{calendar_id}/events", json_data=event_data)
        return response.json()
    ...
    async def get_files(
        ...
        if fields:
            ...
            params["fields"] = "nextPageToken,files(id,name,mimeType,size,createdTime,modifiedTime,webViewLink,thumbnailLink,parents)"
    ...
    async def get_file(self, file_id: str, fields: Optional[str] = None) -> Dict[str, Any]:
        ...
        if fields:
            ...
            params["fields"] = "id,name,mimeType,size,createdTime,modifiedTime,webViewLink,downloadUrl,thumbnailLink,parents"
