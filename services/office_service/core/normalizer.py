...
def normalize_google_email(raw_data: Dict[str, Any], account_email: str, account_name: Optional[str] = None) -> EmailMessage:
    """
...
def normalize_microsoft_email(raw_data: Dict[str, Any], account_email: str, account_name: Optional[str] = None) -> EmailMessage:
    """
    ...
    try:
        ...
        to_addresses = _parse_microsoft_email_addresses(raw_data.get("toRecipients", []))
        cc_addresses = _parse_microsoft_email_addresses(raw_data.get("ccRecipients", []))
        bcc_addresses = _parse_microsoft_email_addresses(raw_data.get("bccRecipients", []))
...
def normalize_google_calendar_event(raw_data: Dict[str, Any], account_email: str, account_name: Optional[str] = None, calendar_name: str = "Default") -> CalendarEvent:
    """
...
def normalize_google_drive_file(raw_data: Dict[str, Any], account_email: str, account_name: Optional[str] = None) -> DriveFile:
    """
...
def _parse_microsoft_email_address(addr_data: Optional[Dict[str, Any]]) -> Optional[EmailAddress]:
...
def _parse_microsoft_email_addresses(addr_list: List[Dict[str, Any]]) -> List[EmailAddress]:
...
def _extract_microsoft_body(body_data: Dict[str, Any]) -> tuple[Optional[str], Optional[str]]:
