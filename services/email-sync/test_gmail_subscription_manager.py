import pytest
from gmail_subscription_manager import refresh_gmail_subscription, scheduled_refresh_job
...
def test_scheduled_refresh_job_logs(monkeypatch, caplog):
    ...
    def fake_refresh(user_id):
        ...
        return True
    monkeypatch.setattr("gmail_subscription_manager.refresh_gmail_subscription", fake_refresh)
    with caplog.at_level("INFO"):
