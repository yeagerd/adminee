...
class UserCursorPaginationRequest(CursorPaginationRequest):
    ...
    onboarding_completed: Optional[bool] = Field(None, description="Filter by onboarding completion status")
...
class UserSearchRequest(BaseModel):
    ...
    limit: Optional[int] = Field(None, ge=1, le=100, description="Number of users per page")
