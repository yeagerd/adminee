...
from services.common.events import EmailEvent, CalendarEvent, DocumentEvent, TodoEvent
...
class TestContactDiscoveryService:
    ...
    def sample_calendar_event(self):
        ...
        return CalendarEvent(
            ...
            event={
                ...
                "organizer": {"email": "organizer@example.com", "name": "Meeting Organizer"},
                "attendees": [
    ...
    def test_process_calendar_event_creates_contacts(self, service, sample_calendar_event):
    ...
    def test_contact_update(self, service, sample_email_event):
        ...
        updated_contact = service.update_contact("user123", "sender@example.com", update_data)
