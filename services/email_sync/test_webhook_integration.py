...
class TestGmailWebhookIntegration(BaseEmailSyncIntegrationTest):
    ...
    def test_gmail_webhook_invalid_secret(self):
        ...
        with app.test_client() as client:
            ...
            app.publish_message.assert_not_called()
    ...
    def test_gmail_webhook_pubsub_failure(self):
        ...
        with app.test_client() as client:
            ...
            app.publish_message.side_effect = Exception("pubsub error")
...
class TestMicrosoftWebhookIntegration(BaseEmailSyncIntegrationTest):
    ...
    def test_microsoft_webhook_pubsub_failure(self):
        ...
        with app.test_client() as client:
            ...
            publish_message.side_effect = Exception("pubsub error")
...
class TestWebhookDataValidation(BaseEmailSyncIntegrationTest):
        ...
        with app.test_client() as client:
            ...
            for payload in test_cases:
                ...
                assert (
                    ...
                    == payload["value"][0]["changeType"]
                )
                assert (
                    published_data["value"][0]["resource"]
    ...
    def test_webhook_malicious_payload_handling(self, mock_publish):
        ...
        with app.test_client() as client:
            ...
            assert (
                "extra_data" not in published_data
            )  # Extra data should be filtered out
