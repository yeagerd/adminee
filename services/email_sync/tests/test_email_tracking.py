...
class TestEmailProcessingState:
    ...
    def test_initialization(self):
        ...
        state = EmailProcessingState(user_email="user@example.com", provider="gmail")
...
class TestEmailTrackingService:
    ...
    def test_mark_email_processed(self, tracking_service):
        ...
        assert state.last_processed_timestamp.replace(
            tzinfo=None
    ...
    def test_multiple_users_and_providers(self, tracking_service):
        ...
        state1_gmail = tracking_service.get_processing_state(
            "user1@example.com", "gmail"
        )
        state1_ms = tracking_service.get_processing_state(
            "user1@example.com", "microsoft"
        )
        state2_gmail = tracking_service.get_processing_state(
