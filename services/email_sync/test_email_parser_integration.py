...
class TestEmailParserSampleDataIntegration:
    ...
    def test_ups_tracking_email_integration(self):
        ...
        with patch('services.email_sync.email_parser_service.publish_message') as mock_publish:
            ...
            tracking_calls = [call for call in mock_publish.call_args_list 
    ...
    def test_amazon_shipped_email_integration(self):
        ...
        with patch('services.email_sync.email_parser_service.publish_message') as mock_publish:
            ...
            amazon_calls = [call for call in mock_publish.call_args_list
    ...
    def test_survey_response_email_integration(self):
        ...
        with patch('services.email_sync.email_parser_service.publish_message') as mock_publish:
            ...
            survey_calls = [call for call in mock_publish.call_args_list 
