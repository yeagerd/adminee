...
from services.email_sync.email_tracking import EmailProcessingState, EmailTrackingService
...
class TestEmailProcessingState:
    ...
    def test_to_dict(self):
        ...
        state.last_processed_timestamp = datetime(2024, 1, 15, 10, 30, 0, tzinfo=timezone.utc)
    ...
    def test_from_dict(self):
        ...
        assert state.last_processed_timestamp == datetime(2024, 1, 15, 11, 0, 0, tzinfo=timezone.utc)
        assert state.history_id is None
...
class TestEmailTrackingService:
    ...
    def tracking_service(self, temp_db_file):
        ...
        with patch('services.email_sync.email_tracking.EmailTrackingService._init_database') as mock_init:
    ...
    def test_multiple_users_and_providers(self, tracking_service):
        ...
        gmail_state_1 = tracking_service.get_processing_state("user1@example.com", "gmail")
        ms_state_1 = tracking_service.get_processing_state("user1@example.com", "microsoft")
        gmail_state_2 = tracking_service.get_processing_state("user2@example.com", "gmail")
