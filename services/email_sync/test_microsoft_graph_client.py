...
class TestMicrosoftGraphClientIntegration:
    ...
    def test_real_microsoft_graph_api_integration_stubbed(self, graph_client):
        ...
        notification = {
            "value": [
                {
                    "changeType": "created",
                    "resource": "me/messages/msg1"
                },
                {
                    "changeType": "created", 
                    "resource": "me/messages/msg2"
                }
            ]
        }
    ...
    def test_microsoft_graph_api_rate_limit_handling_stubbed(self, graph_client):
        ...
        notification = {"value": [{"changeType": "created", "resource": "me/messages/msg1"}]}
    ...
    def test_microsoft_graph_api_authentication_error_handling_stubbed(self, graph_client):
    ...
    def test_microsoft_graph_api_with_different_parameters(self, graph_client):
        ...
        notification1 = {"value": [{"changeType": "created", "resource": "me/messages/msg1"}]}
        notification2 = {"value": [{"changeType": "updated", "resource": "me/messages/msg2"}]}
    ...
    def test_microsoft_graph_api_with_retry_parameters(self, graph_client):
        ...
        result1 = graph_client.fetch_emails_from_notification(notification, max_retries=3)
        result2 = graph_client.fetch_emails_from_notification(notification, max_retries=10)
