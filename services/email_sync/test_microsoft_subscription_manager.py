...
from services.email_sync.microsoft_subscription_manager import refresh_microsoft_subscription, scheduled_refresh_job
...
class TestMicrosoftSubscriptionManagerIntegration:
    ...
    def test_scheduled_refresh_job_stubbed(self):
        ...
        with patch('services.email_sync.microsoft_subscription_manager.refresh_microsoft_subscription') as mock_refresh:
