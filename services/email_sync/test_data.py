...
def gmail_webhook_payload(history_id: str = "12345", email_address: str = "user@example.com") -> Dict[str, Any]:
...
def microsoft_webhook_payload(change_type: str = "created", resource: str = "me/messages/1") -> Dict[str, Any]:
...
def amazon_expected_delivery_email() -> Dict[str, Any]:
    ...
    return {
        ...
        "payload": {
            "headers": [
                {"name": "Subject", "value": "Your Amazon package is expected to arrive tomorrow"},
                {"name": "From", "value": "Amazon <order-update@amazon.com>"},
                {"name": "To", "value": "user@example.com"},
...
def amazon_delayed_email() -> Dict[str, Any]:
    ...
    return {
        ...
        "payload": {
            "headers": [
                {"name": "Subject", "value": "Your Amazon package delivery has been delayed"},
                {"name": "From", "value": "Amazon <order-update@amazon.com>"},
                {"name": "To", "value": "user@example.com"},
...
def get_all_microsoft_emails() -> List[Dict[str, Any]]:
    ...
    return [
        microsoft_ups_email(),
        microsoft_amazon_email(),
        microsoft_survey_email()
    ]
