        ...
        **llm_kwargs,
        ...
        super().__init__(
            ...
            system_prompt=(
                ...
                "2. Hand off to appropriate specialized agents (CalendarAgent for calendar queries, "
                "EmailAgent for email queries, DocumentAgent for document/note queries, "
                "DraftAgent for creating drafts)\n"
                ...
                "- Hand off to the appropriate specialized agent(s)\n"
                ...
                "Available agents:\n"
                "- CalendarAgent: Calendar events, scheduling queries\n"
                "- EmailAgent: Email retrieval, email queries\n"
                "- DocumentAgent: Document and note searches\n"
                "- DraftAgent: Creating drafts for emails, calendar events, or changes"
            ),
            llm=llm,
            tools=tools,
            can_handoff_to=[
