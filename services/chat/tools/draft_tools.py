...
def create_draft_email(
    ...
    **kwargs: Any,
    ...
    logger.warning(
        "create_draft_email called without user_id context - use DraftTools instead"
    )
    try:
        key = f"{thread_id}_email"
        email_data = {
...
def create_draft_calendar_event(
    ...
    **kwargs: Any,
    ...
    logger.warning(
        "create_draft_calendar_event called without user_id context - use DraftTools instead"
    )
    try:
        key = f"{thread_id}_calendar_event"
...
def create_draft_calendar_change(
    ...
    **kwargs: Any,
    ...
    logger.warning(
        "create_draft_calendar_change called without user_id context - use DraftTools instead"
    )
    try:
        # Validate required parameters
        if not event_id or not event_id.strip():
