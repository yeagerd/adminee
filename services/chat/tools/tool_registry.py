...
class ToolRegistry:
    ...
    def list_tools(self) -> List[Tuple[str, str]]:
        ...
        """
        return [
            (tool_id, metadata.description) for tool_id, metadata in self._tools.items()
        ]
    ...
    def search_tools(self, query: str) -> List[Tuple[str, str]]:
        ...
        for tool_id, metadata in self._tools.items():
            if (
                ...
                or query_lower in tool_id.lower()
            ):
    ...
    def export_registry(self) -> Dict[str, Any]:
        ...
        return {
            "tools": {
                tool_id: metadata.to_dict() for tool_id, metadata in self._tools.items()
            },
