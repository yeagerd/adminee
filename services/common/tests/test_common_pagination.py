...
from common.pagination.query_builder import SQLAlchemyCursorQueryBuilder, PostgreSQLCursorQueryBuilder
...
class TestSQLAlchemyCursorQueryBuilder:
    ...
    def test_build_ordering_clause(self):
        ...
        next_ordering = self.query_builder.build_ordering_clause("id", "updated_at", "next")
        prev_ordering = self.query_builder.build_ordering_clause("id", "updated_at", "prev")
