...
class SubscriptionConfig:
    ...
    def get_subscription_name(cls, service_name: str, topic_name: str) -> str:
        ...
        if service_name in cls.SERVICE_SUBSCRIPTIONS:
            if topic_name in cls.SERVICE_SUBSCRIPTIONS[service_name]:
                return cls.SERVICE_SUBSCRIPTIONS[service_name][topic_name]["subscription_name"]
    ...
    @classmethod
    def get_subscription_config(cls, service_name: str, topic_name: str) -> Dict[str, any]:
    ...
    def validate_subscription_config(cls, service_name: str, topic_name: str) -> bool:
        ...
        return (
            service_name in cls.SERVICE_SUBSCRIPTIONS and
            topic_name in cls.SERVICE_SUBSCRIPTIONS[service_name]
        )
    ...
    def get_subscription_stats(cls) -> Dict[str, any]:
        ...
        return {
            ...
            "service_coverage": {
                service: len(topics) for service, topics in cls.SERVICE_SUBSCRIPTIONS.items()
            }
        }
