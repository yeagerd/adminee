...
class EventMetadata(BaseModel):
    ...
    # Request context
    request_id: Optional[str] = Field(None, description="Request ID that triggered this event")
    user_id: Optional[str] = Field(None, description="User ID associated with this event")
    
    # Additional context
    correlation_id: Optional[str] = Field(None, description="Correlation ID for related events")
    tags: Dict[str, Any] = Field(default_factory=dict, description="Additional tags for the event")
...
class BaseEvent(BaseModel):
    ...
    def add_trace_context(self, trace_id: str, span_id: str, parent_span_id: Optional[str] = None) -> None:
    ...
    def add_request_context(self, request_id: str, user_id: Optional[str] = None) -> None:
