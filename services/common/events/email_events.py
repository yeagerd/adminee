...
class EmailBackfillEvent(BaseEvent):
    ...
    start_date: Optional[datetime] = Field(None, description="Start date for backfill range")
    end_date: Optional[datetime] = Field(None, description="End date for backfill range")
