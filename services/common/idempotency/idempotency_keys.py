...
class IdempotencyKeyGenerator:
    ...
    @staticmethod
    def generate_key(
        event_type: str, user_id: str, operation: str, batch_id: Optional[str] = None
    ) -> str:
...
class IdempotencyStrategy:
    ...
    def is_immutable_operation(cls, data_type: str, operation: str) -> bool:
        ...
        return (
            data_type in cls.IMMUTABLE_TYPES
            and operation in cls.IMMUTABLE_TYPES[data_type]
        )
    ...
    def is_mutable_operation(cls, data_type: str, operation: str) -> bool:
        ...
        return (
            data_type in cls.MUTABLE_TYPES and operation in cls.MUTABLE_TYPES[data_type]
        )

    @classmethod
    def is_batch_operation(cls, data_type: str, operation: str) -> bool:
        """Check if an operation is a batch operation for a data type."""
        return data_type in cls.BATCH_TYPES and operation in cls.BATCH_TYPES[data_type]
...
class IdempotencyKeyValidator:
    ...
    def validate_key_uniqueness(
        existing_keys: set, new_key: str, ttl_seconds: int = 86400  # 24 hours
    ) -> bool:
