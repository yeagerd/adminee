...
class RedisReferencePattern:
    ...
    def store_fragment_reference(
        ...
        try:
            ...
            logger.info(f"Stored fragment reference in Redis: {redis_key} (TTL: {ttl}s)")
            return redis_key
    ...
    def extend_ttl(self, redis_key: str, data_type: str, ttl_override: Optional[int] = None) -> bool:
