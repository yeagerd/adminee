...
async def get_contact_discovery_service() -> ContactDiscoveryService:
    ...
    pubsub_client = PubSubClient()  # Simplified - in real implementation, this would be injected
...
async def create_contact(
    ...
    try:
        ...
        return ContactResponse(contact=contact, success=True, message="Contact created successfully")
...
async def update_contact(
    ...
    try:
        ...
        return ContactResponse(contact=contact, success=True, message="Contact updated successfully")
    except NotFoundError:
        raise
    except ValidationError as e:
        raise
    ...
    try:
        ...
        for contact in contacts:
            result = EmailContactSearchResult(
                ...
                match_highlights=[query],  # Simplified - could implement actual highlighting
            )
...
async def get_contact_stats(
    ...
    try:
        stats = await contact_service.get_contact_stats(session=session, user_id=user_id)
