...
def upgrade() -> None:
    ...
    op.create_table('contacts',
        ...
        sa.Column('relevance_factors', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    ...
    op.create_unique_constraint('idx_contacts_user_email', 'contacts', ['user_id', 'email_address'])
