...
class Contact(SQLModel, table=True):
    ...
    id: Optional[str] = Field(default=None, primary_key=True, description="Unique contact ID")
    user_id: str = Field(..., description="User ID who owns this contact")
    email_address: str = Field(..., description="Contact's email address")
    display_name: Optional[str] = Field(default=None, description="Contact's display name")
    given_name: Optional[str] = Field(default=None, description="Contact's given/first name")
    family_name: Optional[str] = Field(default=None, description="Contact's family/last name")

    # Event tracking - stored as JSONB in PostgreSQL
    event_counts: Dict[str, EmailContactEventCount] = Field(
        default_factory=dict, description="Count of events by type for this contact"
    )
    ...
    source_services: List[str] = Field(
        default_factory=list, description="Services where this contact was discovered"
    )
