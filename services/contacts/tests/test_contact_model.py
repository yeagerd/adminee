...
class TestContactModel:
    ...
    def test_to_vespa_document(self, sample_contact):
        ...
        assert vespa_doc["doc_id"] == f"contact_{sample_contact.user_id}_{sample_contact.email_address}"
        ...
        assert vespa_doc["search_text"] == f"{sample_contact.get_primary_name()} {sample_contact.email_address}"
