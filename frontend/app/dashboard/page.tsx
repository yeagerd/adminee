...
import MainPane from '@/components/layout/main-pane';
...
export default function DashboardPage() {
    ...
    return (
        <AppLayout
            ...
            draft={
                <DraftPane>
                    <div className="flex-1 flex items-center justify-center text-muted-foreground">Draft Pane (placeholder)</div>
                </DraftPane>
            }
        />
    );
